...
moduleForModel('i-i-s-otdel-logistiki-тч-раб-вод-авто', 'Unit | Serializer | i-i-s-otdel-logistiki-тч-раб-вод-авто', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-otdel-logistiki-тч-раб-вод-авто',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
